...
const workerConfig = {
  ...
  monitors: [
    ...
    {
      id: 'Icons',
      name: 'Gitlayze`s Icons',
      method: 'GET',
      target: 'https://icons.devops-engineer.com.cn',
      tooltip: 'Gitlayze`s Icons',
      statusPageLink: 'https://icons.devops-engineer.com.cn',
      timeout: 5000,
    },
    {
      id: 'Tools',
      name: 'Gitlayze`s Tools',
      method: 'GET',
      target: 'https://tools.devops-engineer.com.cn',
      tooltip: 'Gitlayze`s Tools',
      statusPageLink: 'https://tools.devops-engineer.com.cn',
      timeout: 5000,
    },
    {
      id: 'Images',
      name: 'Gitlayze`s a picture bed',
      method: 'GET',
      target: 'https://image.devops-engineer.com.cn',
      tooltip: 'Gitlayze`s a picture bed',
      statusPageLink: 'https://image.devops-engineer.com.cn',
      timeout: 5000,
    },
    {
      id: 'Linux',
